...
import {
  CentroOperativoList,
  mockCentroOperativoList,
} from 'src/app/interfaces/centro-operativo';
...
describe('CentrosOperativosListComponent', () => {
  ...
  it('listens for app-table changes', fakeAsync(() => {
    ...
    httpController
      .expectOne(`${environment.api}/centro_operativo/`)
      .flush(mockCentroOperativoList);
    const req = httpController.expectOne(
      `${environment.api}/centro_operativo/${centroOperativo.id}`
    );
