...
describe('CentrosOperativosFormComponent', () => {
  ...
  it('should open edit view', fakeAsync(() => {
    ...
    pageFormComponent = findElement(fixture, 'app-page-form');
    pageFormComponent.triggerEventHandler('backClick', true);
    const paisSelect: HTMLSelectElement = fixture.debugElement.nativeElement.querySelector('#pais-select');
    const localidadSelect: HTMLSelectElement = fixture.debugElement.nativeElement.querySelector('#localidad-select');
    paisSelect.value = `${centroOperativo.ciudad.localidad.pais_id}`;
    paisSelect.dispatchEvent(new Event('change'));
    localidadSelect.value = `${centroOperativo.ciudad.localidad_id}`;
    localidadSelect.dispatchEvent(new Event('change'));
    tick();
