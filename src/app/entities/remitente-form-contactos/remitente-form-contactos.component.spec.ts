...
import { of } from 'rxjs';
import { mockRemitenteContactoGestorCargaList, RemitenteContactoGestorCargaList } from 'src/app/interfaces/remitente-contacto-gestor-carga';
import { TableEvent } from 'src/app/interfaces/table';
import { MaterialModule } from 'src/app/material/material.module';
import { findElement } from 'src/app/utils/test';

import { RemitenteFormContactosComponent } from './remitente-form-contactos.component';

describe('RemitenteFormContactosComponent', () => {
  let component: RemitenteFormContactosComponent;
  let fixture: ComponentFixture<RemitenteFormContactosComponent>;
  let tableComponent: DebugElement;
  const remitenteContacto = mockRemitenteContactoGestorCargaList[0];
  ...
  const tableEvent: TableEvent<RemitenteContactoGestorCargaList> = {
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      ...
      declarations: [ RemitenteFormContactosComponent ]
    })
    .compileComponents();
  });

  beforeEach(() => {
    fixture = TestBed.createComponent(RemitenteFormContactosComponent);
    component = fixture.componentInstance;
    component.form = new FormGroup({
      contactos: new FormArray([]),
    });
    component.contactoList = mockRemitenteContactoGestorCargaList;
