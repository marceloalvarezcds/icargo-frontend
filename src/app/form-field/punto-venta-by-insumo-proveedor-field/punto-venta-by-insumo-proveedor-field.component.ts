...
@Component({
  selector: 'app-punto-venta-by-insumo-proveedor-field',
  templateUrl: './punto-venta-by-insumo-proveedor-field.component.html',
  styleUrls: ['./punto-venta-by-insumo-proveedor-field.component.scss']
})
export class PuntoVentaByInsumoProveedorFieldComponent {
  ...
  private getList(): void {
    if (this.iId && this.pId) {
      this.list$ = this.service.getListByInsumoIdAndProveedorId(this.iId, this.pId);
    }
  }
}
