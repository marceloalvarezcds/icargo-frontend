...
@Component({
  selector: 'app-punto-venta-map-by-efectivo-dialog-field',
  templateUrl: './punto-venta-map-by-efectivo-dialog-field.component.html',
  styleUrls: ['./punto-venta-map-by-efectivo-dialog-field.component.scss']
})
export class PuntoVentaMapByEfectivoDialogFieldComponent {
  ...
  fetchDataFunction = () => this.service.getListByGestorAndPuedeRecibirEfectivo();
