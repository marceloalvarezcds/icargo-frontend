...
describe('SemiListComponent', () => {
  ...
  it('should apply filter', fakeAsync(() => {
    ...
    const tipoCargaFiltered = component.tipoCargaFilterList.filter((_, i) => i === 0);
    ...
    spyOn(component.tipoCargaCheckboxFilter, 'getFilteredList').and.returnValue(tipoCargaFiltered);
