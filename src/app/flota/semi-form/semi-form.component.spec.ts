...
describe('SemiFormComponent', () => {
    ...
    component.form.setValue({
      ...
      municipal: {
        ...
        vencimiento_habilitacion_municipal:
          mockSemi.vencimiento_habilitacion_municipal,
      ...
      transporte: {
        ...
        vencimiento_habilitacion_transporte:
          mockSemi.vencimiento_habilitacion_transporte,
  ...
  it('should open create view', fakeAsync(() => {
    ...
    httpController
      .match(`${environment.api}/tipo_semi/`)
      .forEach((r) => r.flush(mockTipoSemiList));
    httpController
      .match(`${environment.api}/tipo_carga/`)
      .forEach((r) => r.flush(mockTipoCargaList));
    httpController
      .match(`${environment.api}/marca_semi/`)
      .forEach((r) => r.flush(mockMarcaSemiList));
    httpController
      .match(`${environment.api}/semi_clasificacion/`)
      .forEach((r) => r.flush(mockSemiClasificacionList));
    httpController
  ...
  it('should open edit view with alias null', fakeAsync(() => {
    ...
    httpController
      .match(`${environment.api}/semi/${id}/active`)
      .forEach((r) => r.flush(mockSemi));
    httpController
      .match(`${environment.api}/semi/${id}/inactive`)
      .forEach((r) => r.flush(mockSemi));
    flush();
    tick(1);
