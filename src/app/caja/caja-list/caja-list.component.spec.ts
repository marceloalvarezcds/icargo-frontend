...
describe('CajaListComponent', () => {
  ...
  const tableEvent: TableEvent<Caja> = {
    row,
    index: 0,
  };
    ...
    await TestBed.configureTestingModule({
      imports: [
        ...
        RouterTestingModule.withRoutes([
          {
            path: `caja/${m.CAJA}/${a.CREAR}`,
            component: CajaFormComponent,
          },
          {
            path: `caja/${m.CAJA}/${a.EDITAR}/:id`,
            component: CajaFormComponent,
          },
          {
            path: `caja/${m.CAJA}/${a.VER}/:id`,
            component: CajaFormComponent,
          },
        ]),
        SharedModule,
      ...
      declarations: [CajaListComponent, CajaFormComponent],
    }).compileComponents();
  });
  ...
  it('should make an http call to download the list', fakeAsync(() => {
    const filename = 'caja_reports.xls';
