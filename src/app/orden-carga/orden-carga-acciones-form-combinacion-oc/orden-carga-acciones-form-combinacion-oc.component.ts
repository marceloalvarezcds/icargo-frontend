...
@Component({
  selector: 'app-orden-carga-acciones-form-combinacion-oc',
  templateUrl: './orden-carga-acciones-form-combinacion-oc.component.html',
  styleUrls: ['./orden-carga-acciones-form-combinacion-oc.component.scss']
})
export class OrdenCargaAccionesFormCombinacionOcComponent {
  flete?: FleteList;
