// orden-carga-reports.component.ts
...
@Component({
  selector: 'app-orden-carga-reports',
  templateUrl: './orden-carga-reports.component.html',
  styleUrls: ['./orden-carga-reports.component.scss']
})
export class OrdenCargaReportsComponent {
  E = EstadoEnum;
  @Input() oc?: OrdenCarga;
