...
import { CuentaConrrienteInfoComponent } from './cuenta-conrriente-info/cuenta-conrriente-info.component';
...
@NgModule({
  declarations: [
    ...
    EstadoCuentaPdvComponent,
    EstadoCuentaPdvDetalleComponent,
    CuentaConrrienteInfoComponent
  ],
  imports: [
    CommonModule,
    DirectivesModule,
