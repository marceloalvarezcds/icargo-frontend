...
import {
  mockOcRemisionOrigenDialogData,
  mockOcRemisionOrigenDialogDataWithoutItem,
  OcRemisionOrigenDialogData,
} from 'src/app/interfaces/oc-remision-origen-dialog-data';
...
describe('OcRemisionOrigenFormDialogComponent', () => {
  ...
  const mockDialogRefSpyObj = jasmine.createSpyObj({
    close: (data?: OcRemisionOrigenDialogData) => {},
  });
  ...
  it('data should be null', fakeAsync(() => {
    TestBed.overrideProvider(MAT_DIALOG_DATA, {
      useValue: mockOcRemisionOrigenDialogDataWithoutItem,
    });
    fixture = TestBed.createComponent(OcRemisionOrigenFormDialogComponent);
    component = fixture.componentInstance;
    fixture.detectChanges();
  ...
  it('data should be null and should submitted', fakeAsync(() => {
    ...
    expect(submitSpy).toHaveBeenCalled();
    httpController
      .match(`${environment.api}/orden_carga_remision_origen/`)
