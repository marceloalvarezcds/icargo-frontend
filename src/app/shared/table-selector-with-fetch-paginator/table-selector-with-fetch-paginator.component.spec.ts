...
describe('TableSelectorWithFetchPaginatorComponent', () => {
  ...
  let fixture: ComponentFixture<TableSelectorWithFetchPaginatorComponent<FleteList>>;
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent<TableSelectorWithFetchPaginatorComponent<FleteList>>(TableSelectorWithFetchPaginatorComponent);
